...
export default function Greeting() {
  return (
    <section className="w-full bg-gradient-to-r from-[#f8f9fa] via-[#e1e5e8] to-[#f3f4f6] py-8 sm:py-14 px-4 sm:px-6 flex justify-center border-b border-gray-200">
      <div className="max-w-3xl w-full">
        {/* --- Heading --- */}
        <div className="mb-6 sm:mb-8">
          <h2 className="text-2xl sm:text-3xl font-extrabold tracking-tight text-[#192349] drop-shadow-[0_3px_12px_rgba(25,35,73,0.18)] relative z-10" style={{ letterSpacing: "0.02em", textAlign: "right" }}>
